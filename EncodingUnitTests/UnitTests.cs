...
namespace EncodingUnitTests
{
    ...
    public class UnitTests
    {
        ...
        public void HashDefaultValuesStream()
        {
            ...
            {
               Assert.AreEqual(@"EQ9q1Hjyr_pfSBj1_M2vqAMFH-MYhP2zwhgYfC8u8-g", BerTlvLogic.ComputeBase64Blake2bHashInBuffers(temp));
            }           
        }
        ...
        public void HashStreamWithLargeBuffer()
        {
            ...
            using (Stream temp = new MemoryStream(Encoding.UTF8.GetBytes(startString)))
            {
                Assert.AreEqual(@"EQ9q1Hjyr_pfSBj1_M2vqAMFH-MYhP2zwhgYfC8u8-g", BerTlvLogic.ComputeBase64Blake2bHashInBuffers(temp,32,1280));
            }
        }
